  ...
  const services = [
    {
      ...
      description: 'Полное сопровождение процедуры банкротства граждан. Списание долгов по кредитам, займам, ЖКХ.',
    },
    {
      icon: 'Briefcase',
      title: 'Банкротство юридических лиц',
      description: 'Юридическое сопровождение процедуры банкротства компаний. Защита интересов кредиторов и должников.',
    },
    {
      icon: 'FileText',
      title: 'Правовое консультирование',
      description: 'Консультации по вопросам банкротства, анализ финансовой ситуации, разработка стратегии.',
    },
    {
      icon: 'Shield',
      title: 'Защита от кредиторов',
      description: 'Представительство в суде, защита имущества, работа с коллекторами и приставами.',
    },
  ];
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="text-white space-y-6 animate-fade-in">
              ...
              <p className="text-xl text-blue-50 leading-relaxed">
                Профессиональная юридическая помощь в решении долговых проблем. 
                Освобождаем от долгов законно и надёжно.
              </p>
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto max-w-6xl">
          <div className="text-center mb-16 space-y-4 animate-slide-up">
            <h2 className="text-4xl lg:text-5xl font-bold text-foreground">Наши услуги</h2>
